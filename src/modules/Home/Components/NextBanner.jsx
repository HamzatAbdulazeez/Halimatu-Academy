          ...
          <div className="relative h-full min-h-80 overflow-hidden">
            ...
            <div className="absolute bottom-8 left-8 right-8 grid grid-cols-2 gap-4">
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                <p className="text-3xl font-bold text-emerald-600">{t.aboutstats.activeStudents}</p>
                <p className="text-sm text-black">{t.aboutstats.activeStudentsLabel}</p>
              </div>
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                <p className="text-3xl font-bold text-blue-600">{t.aboutstats.expertScholars}</p>
                <p className="text-sm text-black">{t.aboutstats.expertScholarsLabel}</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:p-12 sm:p-6 p-6 space-y-4 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <h3 className="font-semibold text-gray-900">{t.about.featureFlexibleTitle}</h3>
                <p className="text-sm text-gray-600">{t.about.featureFlexibleDesc}</p>
              </div>
            </div>
