                            ...
                            >
                                {code.map((digit, i) => (
                                    <input
                                        ...
                                        className={`w-12 h-12 text-center text-xl font-bold border rounded-lg outline-none transition ${codeTouched && codeError
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-3 border rounded-lg outline-none transition pr-12 ${passwordTouched && passwordError
                                        ? "border-red-500 bg-red-50 focus:border-red-500"
                                        : "border-gray-300 focus:border-[#004aad] focus:ring-2 focus:ring-blue-100"
                                        }`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-3 border rounded-lg outline-none transition pr-12 ${confirmTouched && confirmError
                                        ? "border-red-500 bg-red-50 focus:border-red-500"
                                        : "border-gray-300 focus:border-[#004aad] focus:ring-2 focus:ring-blue-100"
                                        }`}
                            ...
                            {confirmTouched && confirmPassword.length > 0 && (
                                <p className={`mt-1.5 text-xs flex items-center gap-1 ${confirmPassword === password ? "text-green-600" : "text-red-600"
                                    }`}>
                ...
                <form onSubmit={handleSendCode} className="space-y-6" noValidate>
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 border rounded-lg outline-none transition ${emailTouched && emailError
                                ? "border-red-500 bg-red-50 focus:border-red-500"
                                : "border-gray-300 focus:border-[#004aad] focus:ring-2 focus:ring-blue-100"
                                }`}
