...
import { BookOpen, Pencil, Trash2, Tag, Settings, CheckCircle, Eye } from 'lucide-react';

const CourseCard = ({ course, onEdit, onDelete, onManageTopics }) => (
    <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
        ...
        {course.image ? (
            ...
            <div className="h-20 bg-linear-to-r from-[#004aad]/10 to-teal-500/10 flex items-center justify-center">
